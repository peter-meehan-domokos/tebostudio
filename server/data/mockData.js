...
const rehabMeasures = [
  //sharpness
  { preInjuryValue:27.2, key:"s1", name:"Max Speed", label:"MAX", categoryKey:"sharpness", range:[20, 35], order : "low-to-high" },
  { preInjuryValue:0.25, key:"s2", name:"Turn Rate - Decel (sec)", label:"TRD", categoryKey:"sharpness", optimalValue:"min" },
  { preInjuryValue:0.16, key:"s3", name:"Turns Rate - Accel (sec)", label:"TRA", categoryKey:"sharpness", optimalValue:"min" },
  { preInjuryValue:19, key:"s4", name:"Short Sprints (nr)", label:"SS", categoryKey:"sharpness", optimalValue:"max" },
  { preInjuryValue:10, key:"s5", name:"Self-Report (/10)", label:"REP", categoryKey:"sharpness", optimalValue:"max" },
  //cardio
  { preInjuryValue:8, key:"c1", name:"High Speed Runs (nr)", label:"HSR", categoryKey:"cardio", optimalValue:"max" },
  { preInjuryValue:15, key:"c2", name:"Med Speed Runs (nr)", label:"MSR", categoryKey:"cardio", optimalValue:"max" },
  { preInjuryValue:9.8, key:"c3", name:"Total Distance (km)", label:"TOT", categoryKey:"cardio", optimalValue:"max" },
  { preInjuryValue:25, key:"c4", name:"Ball Actions (nr)", label:"ACT", categoryKey:"cardio", optimalValue:"max" },
  { preInjuryValue:10, key:"c5", name:"Self-Report (/10)", label:"REP", categoryKey:"cardio", optimalValue:"max" },
  //postural
  { preInjuryValue:0, key:"p1", name:"Knee Flex (deg)", label:"KF", categoryKey:"postural", optimalValue:"min" },
  { preInjuryValue:180, key:"p2", name:"Knee Ext (deg)", label:"KE", categoryKey:"postural", optimalValue:"max" },
  ...
  { preInjuryValue:10, key:"p4", name:"Squat Position (/10)", label:"SQU", categoryKey:"postural", optimalValue:"min" },
  { preInjuryValue:10, key:"p5", name:"Self-Report (/10)", label:"REP", categoryKey:"postural", optimalValue:"min" },
  //technical
  { preInjuryValue:92, key:"t1", name:"Ball Control (%)", label:"CON", categoryKey:"technical", optimalValue:"min" },
  { preInjuryValue:64, key:"t2", name:"Attacking Pass Success (%)", label:"APS", categoryKey:"technical", optimalValue:"min" },
  { preInjuryValue:77, key:"t3", name:"Forward Pass Success (%)", label:"FPS", categoryKey:"technical", optimalValue:"min" },
  { preInjuryValue:74, key:"t4", name:"Dribble Success (%)", label:"DS", categoryKey:"technical", optimalValue:"min"},
  { preInjuryValue:79, key:"t5", name:"Shots On Target (%)", label:"SOT", categoryKey:"technical", optimalValue:"min" },
]
/*
The Data story
